...
#define adc_channel_e_enum 0="NONE",11="CLT (PC0)",5="FUELPRESS (PA4)",8="IAT (PA7)",4="KNOCK (PA3)",9="MAF (PB0)",13="MAP (PC2)",3="O2 (PA2)",7="OILPRESS (PA6)",15="OILTEMP (PC4)",1="PA0",2="PA1",6="PA5",10="PB1",16="PC5",12="TPS (PC1)",14="VBAT (PC3)"
#define adc_channel_e_fullenum "NONE","PA0","PA1","O2 (PA2)","KNOCK (PA3)","FUELPRESS (PA4)","PA5","OILPRESS (PA6)","IAT (PA7)","MAF (PB0)","PB1","CLT (PC0)","TPS (PC1)","MAP (PC2)","VBAT (PC3)","OILTEMP (PC4)","PC5"
...
#define brain_input_pin_e_enum 0="NONE",68="ACPRESS (PE2)",73="ACSW (PE7)",66="CKP (PE0)",70="CLUTCH (PE4)",67="CMP (PE1)",54="FLEX (PD4)",78="PE12",79="PE13",80="PE14",81="PE15",71="PSP (PE5)",56="RX3 (PD6)",55="TX3 (PD5)",10="VESW (PA8)",7="VSS (PA5)"
#define brain_input_pin_e_fullenum "NONE","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","VSS (PA5)","INVALID","INVALID","VESW (PA8)","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","FLEX (PD4)","TX3 (PD5)","RX3 (PD6)","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","CKP (PE0)","CMP (PE1)","ACPRESS (PE2)","INVALID","CLUTCH (PE4)","PSP (PE5)","INVALID","ACSW (PE7)","INVALID","INVALID","INVALID","INVALID","PE12","PE13","PE14","PE15"
...
#define output_pin_e_enum 0="NONE",64="AC RELAY (PD14)",50="CAN 1 RX (D0)",51="CAN 1 TX (D1)",58="CHECK (PD8)",57="CLT GAUGE (PD7)",72="FAN (PE6)",65="FAN2 (PD15)",40="IDLE (PC6)",74="IGN1 (PE8)",75="IGN2 (PE9)",76="IGN3  (PE10)",77="IGN4 (PE11)",63="INJ1 (PD13)",62="INJ2 (PD12)",61="INJ3 (PD11)",60="INJ4 (PD10)",59="LED (PD9)",41="O2 HEATER (PC7)",24="PB6",25="PB7",26="PB8",27="PB9",78="PE12",79="PE13",80="PE14",81="PE15",69="PUMP (PE3)",56="RX3 (PD6)",30="SPI2 CS (B12)",32="SPI2 MISO (B14)",33="SPI2 MOSI (B15)",31="SPI2 SCK (B13)",47="TACHO (PC13)",55="TX3 (PD5)"
#define output_pin_e_fullenum "NONE","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","PB6","PB7","PB8","PB9","INVALID","INVALID","SPI2 CS (B12)","SPI2 SCK (B13)","SPI2 MISO (B14)","SPI2 MOSI (B15)","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","IDLE (PC6)","O2 HEATER (PC7)","INVALID","INVALID","INVALID","INVALID","INVALID","TACHO (PC13)","INVALID","INVALID","CAN 1 RX (D0)","CAN 1 TX (D1)","INVALID","INVALID","INVALID","TX3 (PD5)","RX3 (PD6)","CLT GAUGE (PD7)","CHECK (PD8)","LED (PD9)","INJ4 (PD10)","INJ3 (PD11)","INJ2 (PD12)","INJ1 (PD13)","AC RELAY (PD14)","FAN2 (PD15)","INVALID","INVALID","INVALID","PUMP (PE3)","INVALID","INVALID","FAN (PE6)","INVALID","IGN1 (PE8)","IGN2 (PE9)","IGN3  (PE10)","IGN4 (PE11)","PE12","PE13","PE14","PE15"
...
#define SIGNATURE_HASH 2925464219
...
#define switch_input_pin_e_enum 0="NONE",68="ACPRESS (PE2)",73="ACSW (PE7)",66="CKP (PE0)",70="CLUTCH (PE4)",67="CMP (PE1)",54="FLEX (PD4)",78="PE12",79="PE13",80="PE14",81="PE15",71="PSP (PE5)",56="RX3 (PD6)",55="TX3 (PD5)",10="VESW (PA8)",7="VSS (PA5)"
#define switch_input_pin_e_fullenum "NONE","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","VSS (PA5)","INVALID","INVALID","VESW (PA8)","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","FLEX (PD4)","TX3 (PD5)","RX3 (PD6)","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","INVALID","CKP (PE0)","CMP (PE1)","ACPRESS (PE2)","INVALID","CLUTCH (PE4)","PSP (PE5)","INVALID","ACSW (PE7)","INVALID","INVALID","INVALID","INVALID","PE12","PE13","PE14","PE15"
...
#define TS_SIGNATURE "rusEFI main.2025.07.01.EECV.2925464219"
